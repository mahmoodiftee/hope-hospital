        ...
        <View style={styles.card} className="shadow-lg">
            <View className="flex-row gap-4 items-center justify-start mb-2.5">
                ...
                <View style={{ flex: 1 }} className="h-full items-start pt-4">
                    <Text className="text-2xl font-medium text-dark mb-0">{doctor.name}</Text>
            ...
            <View className="flex-row items-center">
                <TouchableOpacity className="bg-blue flex-1 py-3 rounded-xl mr-2" onPress={onBookNow}>
                ...
                >
                    <Text className="text-center font-semibold text-gray-800">Detail</Text>
                </TouchableOpacity>
                <TouchableOpacity className="p-2.5 border border-gray-100/50 rounded-xl" onPress={onCall}>
